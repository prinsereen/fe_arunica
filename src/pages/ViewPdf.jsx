...
const ViewPdf = () => {
    return (
        ...
        <div className="mx-44 flex flex-col justify-center items-center">
            ...
            <Link to="/imagination/MyLiterature/book/ringkasan/aaa" className="text-white mt-4 text-center  w-36 p-1 rounded-lg bg-[#1450A3] hover:bg-blue-900 border">Buat Ringkasan</Link>
        </div>
        <Footer/>
        </>
    );

        ...
        <>
            <div className="grid grid-cols-4 mx-44 mt-12">
                <div className=" flex flex-col justify-center items-center">
                    <Link to={`${data.path}/jsnacasj2893sn`} className="w-1/2 flex flex-col justify-center items-center">
                        <img className=" w-1/2" src={Matematika} alt="bindo" />
                        <h2 className="font-bold">Matematika</h2>
                    </Link>
                </div>
                <div className=" flex flex-col justify-center items-center">
                    <Link to={`${data.path}/idMapel`} className="w-1/2 flex flex-col justify-center items-center">
